...
－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
<template>
  <vha-page class="native_PG-contacts">

    <vha-scrollview class="p_UI-content">
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="getAll()">
        获取通讯录
      </vha-button>
      ...
      <vha-button block effect="spread" color="error" size="fullWidth" @click="save()">
        保存
      </vha-button>
