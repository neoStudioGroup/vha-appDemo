...
<template>
  <vha-page class="native_PG-bluetooth">
    ...
    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="enable()">
        开启蓝牙
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="scan()">
        扫描周围蓝牙
      </vha-button>
      ...
      <vha-button block effect="spread" color="error" size="fullWidth" @click="connectFun()">
        连接蓝牙
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="read()">
        读取数据
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="disconnect()">
        断开蓝牙
      </vha-button>
    </vha-scrollview>
