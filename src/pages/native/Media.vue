...
－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
<template>
  <vha-page class="native_PG-media">

    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Record()">
        {{btntext}}
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="playRecord()">
        播放录音
      </vha-button>
    </vha-scrollview>
