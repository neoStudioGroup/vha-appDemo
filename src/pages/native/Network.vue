...
－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
<template>
  <vha-page class="native_PG-network">

    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Network_getType()">
        获取网络状态
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Network_isOnline()">
        判断网络是否在线
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Network_isOffline()">
        判断网络是否离线
      </vha-button>
    </vha-scrollview>
