...
－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
<template>
  <vha-page class="native_PG-file">

    <vha-scrollview class="p_UI-content">
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="getFreeDiskSpace()">
        获取设备总空闲空间
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="checkDir()">
        检测目录
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="createDir()">
        创建目录
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="removeDir()">
        删除目录
      </vha-button>

      <vha-button block effect="spread" color="error" size="fullWidth" @click="checkFile()">
        检测文件
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="createFile()">
        创建文件neo.txt
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="writeFile()">
        写入文件neo.txt > neoStudioGroup.com
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="readFile()">
        读取neo.txt
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="removeFile()">
        删除文件
      </vha-button>
    </vha-scrollview>
