...
<template>
  <vha-page class="native_PG-sqlite">
    ...
    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Echotest()">
        Echo测试
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Selftest()">
        Self测试
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @9click="SQLite()">
        本地数据库
      </vha-button>
    </vha-scrollview>
