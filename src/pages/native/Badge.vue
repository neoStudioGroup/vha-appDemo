...
－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
<template>
  <vha-page class="native_PG-badge">
    
    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Badge_hasPermission()">
        检测权限
      </vha-button>
      ...
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Badge_set()">
        设置数值({{Badge_number}})
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Badge_get()">
        获取数值
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Badge_clear()">
        清除数值
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Badge_increase()">
        增加 + 10
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="Badge_decrease()">
        减少 - 10
      </vha-button>
    </vha-scrollview>
