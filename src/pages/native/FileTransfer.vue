...
<template>
  <vha-page class="native_PG-filetransfer">
    ...
    <vha-scrollview class="p_UI-content">
      ...
      <vha-button block effect="spread" color="error" size="fullWidth" @click="downloadFile()">
        下载文件
      </vha-button>
      
      <p>上传进度{{uploadProgress}}%</p>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="uploadFile()">
        上传文件
      </vha-button>
    </vha-scrollview>
