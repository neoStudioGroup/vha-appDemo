...
<template>
  <vha-page class="native_PG-nativeaudio">
    ...
    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="play('bass')">
        播放bass
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="play('highhat')">
        播放highhat
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="play('snare')">
        播放snare
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="loop('bass')">
        循环bass
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="stop('bass')">
        停止bass
      </vha-button>
    </vha-scrollview>
