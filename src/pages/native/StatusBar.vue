...
<template>
  <vha-page class="native_PG-statusbar">
    ...
    <vha-scrollview class="p_UI-content">
      <vha-button block effect="spread" color="error" size="fullWidth" @click="StatusBaroverlaysWebView()">
        状态栏不占用视图
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="StatusBarstyle()">
        样式
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="StatusBarstyleColor()">
        背景颜色
      </vha-button>
      
      <vha-button block effect="spread" color="error" size="fullWidth" @click="StatusBarshowhide()">
        显示/隐藏
      </vha-button>
    </vha-scrollview>
